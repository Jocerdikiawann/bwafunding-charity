<script>
  ...
  function calculateFunded(pledged, target) {
    return Math.round((1 / (target / pledged)) * 10);
  }
  ...
  function calculateDaysRemaining(date_end) {
    //new date is now date
    const delta = date_end - new Date();
    //24 jam * 60 menit * 60 detik * 1000 mili detik
    const oneDay = 24 * 60 * 60 * 1000;
    //hasilnya sebelum tanggal target di variabel date_end
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-lg-4 col-md-6">
          ...
          <Modal>
               <!-- content here -->
              <div class="modal fade show shadow-sm" id="exampleModal" tabindex="-1" role="dialog"
          ...
          <div class="xs-popular-item xs-box-shadow">
            ...
            <div class="xs-item-content">
              ...
              <a
                href="/donation/{charity.id}" data-toggle="modal" data-target="#exampleModal"
...
<!-- <div>
  ...
  {:else}
    <p class="text-mute">Data Tidak tersedia</p>
  {/if}
</div> -->
